    ...
    return (   
        <>
           <header class="flex justify-between items-center text-black py-6 px-8 md:px-32 bg-orange-100 drop-shadow-md">
                <div className="flex">
                         <h2 className="flex font-extrabold text-2xl"><span className="absolute top-6 left-0 animate-bounce"><Icorn /> </span><span className="absolute top-9 left-14 animate-bounce">RADIO RICKESS</span> </h2>
                </div>
                ...
                <span className="mr-0"><UserPlus /> </span>       
                 <button className="bg-red-600 rounded-xl border-2 mr-4 p-1">connexion</button>     
                 <button className="fixed right-0  bg-red-600 rounded-xl border-2 p-1 mr-2">creer un compte</button>  
                 </div>
                ...
                { isMenuOpen && ( 
                        ...
                        <li className="list-none w-full text-center p-4 hover:bg-sky-400 hover:text-white transition-all cursor-pointer"><Link>Catégories</Link></li> 
                </div>
                )}
